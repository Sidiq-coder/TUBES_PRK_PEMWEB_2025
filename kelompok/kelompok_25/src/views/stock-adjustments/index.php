    ...
    <div class="bg-white border border-slate-100 rounded-3xl shadow-sm p-6">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <input type="text" id="searchInput" placeholder="Cari..." class="mt-1 w-full rounded-xl border border-slate-200 px-4 py-2 shadow-sm focus:ring-2 focus:ring-blue-100 focus:border-blue-400">
            </div>
        </div>
    </div>
